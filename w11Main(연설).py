speech=["AT this second appearing to take the oath of the Presidential office there is less occasion for an extended address than there was at the first",
...
def FrequentWords(c,d):
    ...
    return wd
wordD=countWords()
Fwords=FrequentWords(8,wordD)
print "Licoln speech Frequent words:", Fwords

address= ['Vice President Cheney Mr Chief Justice President Carter President Bush President Clinton reverend clergy distinguished guests fellow citizens',
...
def FRWords(b,d):
    ...
    return abc
wordT=CWords()
Rword=FRWords(23,wordT)
print "Bush address Frequent words:", Rword
input()